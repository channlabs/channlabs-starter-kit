import { PanelLeftCloseIcon, PanelRightOpenIcon } from "@hugeicons/core-free-icons"
...
function SidebarTrigger({
  ...
  return (
    <Button
      ...
      {...props}
    >
      {isMobile || state === "collapsed" ? <HugeiconsIcon icon={PanelRightOpenIcon} size={20} strokeWidth={2} /> : <HugeiconsIcon icon={PanelLeftCloseIcon} size={20} strokeWidth={2} />}
