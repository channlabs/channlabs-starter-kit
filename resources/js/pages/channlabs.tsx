...
export default function Channlabs({
    ...
    return (
        <>
            <Head title="Channlabs Starter Kit - Premium Laravel React Boilerplate" />

            <div className="relative flex min-h-screen flex-col overflow-hidden">
                {/* Background Effects */}
                <div className="pointer-events-none absolute top-0 left-1/2 z-0 h-full w-full -translate-x-1/2 overflow-hidden">
                    <div
                ...
                {/* Header */}
                <header className="relative z-10 mx-auto flex w-full max-w-7xl items-center justify-between px-6 py-4 lg:px-12">
                    <div className="flex items-center gap-2">
                        <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-linear-to-br from-blue-500 to-blue-600 shadow-lg shadow-blue-500/20">
                            <HugeiconsIcon
                                icon={ZapFreeIcons}
                                size={24}
                                strokeWidth={1.5}
                ...
                <section className="relative z-10 mx-auto flex w-full max-w-7xl flex-col items-center px-6 py-16 text-center lg:px-12 lg:py-24">
                    <div className="mb-4 inline-flex items-center gap-2 rounded-full border border-blue-500/20 bg-blue-500/10 px-3 py-1 text-xs font-medium text-blue-600 dark:bg-blue-500/20 dark:text-blue-400">
                        <HugeiconsIcon
                            icon={SparklesIcon}
                            size={14}
                            strokeWidth={2}
                    ...
                    <h1 className="max-w-4xl font-mona text-5xl font-extrabold tracking-tighter sm:text-7xl">
                        Build SaaS Apps{' '}
                        <span className="bg-linear-to-tr from-blue-500 to-purple-600 bg-clip-text text-transparent">
                            10x Faster
                        </span>
                    </h1>
                    ...
                    {/* Stats */}
                    <div className="mt-16 grid w-full grid-cols-3 gap-8 border-y py-8">
                        <div>
                            <div className="font-mona text-3xl font-bold tracking-tighter text-blue-500">
                                50+
                            </div>
                ...
                {/* What's Included */}
                <section className="relative z-10 mx-auto w-full max-w-7xl px-6 py-16 lg:px-12">
                    <div className="rounded-3xl border bg-muted-foreground/2 p-8 backdrop-blur lg:p-12">
                ...
                <section className="relative z-10 mx-auto w-full max-w-7xl px-6 py-16 text-center lg:px-12 lg:py-24">
                    <div className="rounded-3xl border border-blue-500/20 bg-linear-to-br from-blue-500/10 to-purple-500/10 p-12 backdrop-blur">
                ...
                {/* Footer */}
                <footer className="relative z-10 border-t border-dashed bg-background px-6 py-8">
...
function FeatureCard({
    ...
    return (
        <div className="group rounded-3xl border bg-muted-foreground/2 p-6 backdrop-blur transition-all hover:border-blue-500/50 hover:shadow-lg hover:shadow-blue-500/10">
...
function TechCard({
    ...
    return (
        <div className="rounded-2xl border bg-muted-foreground/2 p-6 text-center backdrop-blur transition-all hover:border-blue-500/50">
            ...
            <h4 className="font-mona text-sm font-bold tracking-tighter">
                {name}
            </h4>
